...
public class ControladorPelicula implements ActionListener, ListSelectionListener, DocumentListener {
    ...
    public ControladorPelicula(VentanaPrincipal vista, ListaEnlazada modelo, Pila pila, Cola cola) {
        ...
        this.vista.panelFormulario.btnEstructurasAvanzadas.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (fuente == vista.panelFormulario.btnGuardar) {
            ...
            abrirDialogoDemo();
        } else if (fuente == vista.panelFormulario.btnEstructurasAvanzadas) {
            abrirDialogoEstructurasAvanzadas();
    ...
    /**
     * Opens the advanced data structures dialog showing BST, Sorting, and Graphs
     */
    private void abrirDialogoEstructurasAvanzadas() {
        try {
            Vista.DialogoEstructurasAvanzadas dialog = new Vista.DialogoEstructurasAvanzadas(vista);
            
            // Cargar películas desde el modelo
            Pelicula[] peliculas = modelo.obtenerTodasLasPeliculas();
            dialog.setPeliculas(peliculas);
            
            dialog.setVisible(true);
            
            actualizarEstado("Diálogo estructuras avanzadas cerrado");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(vista, 
                "Error al abrir diálogo de estructuras avanzadas: " + ex.getMessage(), 
                "Error", 
                JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
