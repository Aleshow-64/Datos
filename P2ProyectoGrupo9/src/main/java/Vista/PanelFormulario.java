...
public class PanelFormulario extends JPanel {
	...
	public JButton btnEstructurasAvanzadas; // opens advanced data structures
	...
	public PanelFormulario() {
		...
		// Botón Demo Estructuras Básicas
		...
		// Botón Estructuras Avanzadas
		btnEstructurasAvanzadas = new JButton("🚀 Estructuras Avanzadas");
		styleButton(btnEstructurasAvanzadas, new Color(220, 20, 60));
		btnEstructurasAvanzadas.setToolTipText("Árbol Binario, Ordenamiento Rápido, Grafos - Sin usar Collections");
			...
			groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(btnDemoEstructuras, GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
							.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
							.addComponent(btnEstructurasAvanzadas, GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				...
				.addGap(10)
				.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
					.addComponent(btnDemoEstructuras, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
					.addComponent(btnEstructurasAvanzadas, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE))
				.addGap(15))
		);
